...
import { autoDetectRenderer, type IRendererOptionsAuto, Program, VERSION, type IRenderer as PixiRendererInterface } from "@pixi/core";
...
export class PixiRenderer implements IRenderer {
	 ...
	 * REQUIRES `@pixi/extract` RENDERER PLUGIN TO WORK!!!
