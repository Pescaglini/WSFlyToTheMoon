import type { Loader } from "@pixi/assets";
import { type AssetExtension, LoaderParserPriority, type ResolvedAsset } from "@pixi/assets";
import { extensions, ExtensionType, utils } from "@pixi/core";
import { BitmapFont, BitmapFontData } from "@pixi/text-bitmap";
...
const mtsdfAssetExtension: AssetExtension<MSDFJson | BitmapFont, any> = {
	...
	loader: {
		...
		async parse<BitmapFont>(asset: MSDFJson, options: ResolvedAsset, loader: Loader): Promise<BitmapFont> {
