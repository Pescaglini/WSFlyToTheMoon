...
export class DataManager {
	...
	private static savedataConflictSolver: (oldSavedata: Dictionary<any>, oldVersion: string) => Dictionary<any>;
	...
	public static initialize(
		...
		savedataConflictSolver: (oldSavedata: Dictionary<any>, oldVersion: string) => Dictionary<any> = (_) => new Dictionary<any>()
	): void {
