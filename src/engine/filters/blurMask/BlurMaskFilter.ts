...
import { Filter, Matrix, Point, Rectangle, TextureMatrix } from "@pixi/core";
import type { IPoint, CLEAR_MODES, FilterSystem, RenderTexture, ISpriteMaskTarget } from "@pixi/core";
