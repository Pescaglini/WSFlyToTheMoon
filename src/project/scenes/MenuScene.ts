...
export class MenuScene extends PixiScene {
	...
	constructor() {
		...
		console.log("The next string is localized:", i18next.t("menu.title"));
		console.log("The next string is also localized:", i18next.t("settings.muteSFX"));

		// SoundLib.playMusic("music/musical.mp3");

		const s: Sprite = Sprite.from("img/big_placeholder/bg_game.png");
		this.addChild(s);
		const t = new Tween(s);
